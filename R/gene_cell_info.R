...
#' @description This data set contains baseline expression measurements for genes in cell lines [without any experimental perturbations] as profiles by LINCS
#' @docType data
